...
//($row = mysqli_fetch_array($answer));//{
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-block titulo bg-primary">
                        <h5 style="float:left">Solicitudes / Pagos / Rechazar / Contabilidad</h5>
    ...
    <body>
        ...
        <font color="#003366">
            ...
            <p>
                Por medio del presente correo, se le notifica que el área Contabilidad ha rechazado la solicitud de pago con la siguiente información
            </p>	
    ...
    $asunto = "Rechazo Solicitud | Contabilidad | Folio: ".$idSolicitud." | Solicitante: ".$usuario.".";
    ...
    if($envio == true){
        $solicitud->set('estatus', "Rechazado Contabilidad");
        $solicitud->set('motivoRechazo', $motivo);
        $answer  = $solicitud->rechazarSolicitud();

        if($answer){
            logs($idSolicitud,$usuarioS,'Rechazo solicitud Contabilidad: '.$motivo);
        }
