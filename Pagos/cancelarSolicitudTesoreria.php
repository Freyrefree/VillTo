...
//($row = mysqli_fetch_array($answer));//{
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-block titulo bg-primary">
                        <h5 style="float:left">Solicitudes / Pagos / Rechazar / Tesorería</h5>
    ...
    $asunto = "Rechazo Solicitud | Tesorería | Folio: ".$idSolicitud." | Solicitante: ".$usuario.".";
    ...
    if($envio == true){
        $solicitud->set('estatus', "Rechazado Tesoreria");
        $solicitud->set('motivoRechazo', $motivo);
        $answer  = $solicitud->rechazarSolicitud();
        if($answer){
            logs($idSolicitud,$usuarioS,'Rechazo solicitud Tesorería: '.$motivo);
            $envio = true;
